...
<body >
 ...
 <button type="submit" class="btn btn-primary btn-lg" ><a href="password.php" class="text-light">Change password</a></button><br/>
                        ...
                        <a class="dropdown-item" href="logout.php">Decnnecter</a>
                    </div>
                </li>
            </ul>
        </nav>
                        ...
                        <div class="nav">
                           ...
                           <div class="sb-sidenav-menu-heading">Student profil</div>
                            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                                <div class="sb-nav-link-icon"><i class="fas fa"></i>Plus</div>
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="darsh.php">Statistiques</a>
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="darsh.php">Login</a>
                        ...
                        <input type="submit" name="fin_submit" value="fin cours" onclick="fin_cours();">
                            ...
                            <!-- <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">Liste des cours</div>
                                    
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Programme des cours</div>
