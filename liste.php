...
<html>
    ...
    <div class="demo-content">
		<h2 class="title_with_link bg-dark">Student profil</h2>
...
<?php if(!empty($result))	 { ?>
	<table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
        ...
        <tr>
          ...
          <th width="20%"><span>Sexe</span></th>
		  <th width="20%"><span>Phone</span></th>
		  <th width="20%"><span>Profil</span></th>	  
        </tr>
      </thead>
    <tbody>
	<?php
	...
	?>
        <tr>
			...
			<td> <a href="profilstudent.php?id=<?php echo $row["id"]; ?>">Profil</a></td>
