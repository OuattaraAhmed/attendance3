<?php
	...
	if(!empty($_POST["search"]["datesign"])) {			
      ...
      $sql = "select student.name, attendance.datesign, attendance.why  from student, attendance where student.id = attendance.iduser";
...
<table class="table-content">
        ...
        <tr>
          ...
          <th width="50%"><span>datesign</span></th>          
